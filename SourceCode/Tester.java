 ...
 * <a href="https://www.dcode.fr/maze-generator">...</a>
 *
 * @author Brian Rogers
 */
public class Tester {
    ...
    private static void printDialog() {
        ...
        System.out.println("3: Huge Solvable Maze");
    ...
    public static void main(String[] args) {
        ...
        while (!exit) {
            ...
            switch (choice) {
                case 1 -> {
                    Maze solvableMaze = loadMaze("SourceCode/SolvableMaze.txt");
                ...
                case 2 -> {
                    Maze unsolvableMaze = loadMaze("SourceCode/UnsolvableMaze.txt");
                ...
                case 3 -> {
                    Maze hugeSolvableMaze = loadMaze("SourceCode/HugeSolvableMaze.txt");
