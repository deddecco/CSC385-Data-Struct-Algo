...
public class OuterTest {
     ...
     private static void testEmptyTree() {
          ...
          List<Integer> ansList = List.of();

          Set<Integer> ans = new HashSet<>(ansList);
     ...
     private static void testSingleNode() {
          ...
          Integer[] ansList = new Integer[50];

          Set<Integer> ans = new HashSet<>();

          Collections.addAll(ans, ansList);
     ...
     private static void testThreeNodes() {
          ...
          List<Integer> ansList = asList(50, 25, 75);
     ...
     private static void testBalancedTree7() {
          ...
          List<Integer> ansList = asList(63, 22, 16, 7, 3, 13, 21, 25, 27, 31, 33, 55, 64, 69, 72, 79, 83, 86, 92, 85, 78);
     ...
     private static void testBalancedTree6() {
          ...
          List<Integer> ansList = asList(36, 19, 8, 22, 23, 58, 75, 94, 73);
     ...
     private static void testBalancedTree5() {
          ...
          List<Integer> ansList = asList(65, 26, 15, 21, 27, 63, 68, 80, 92, 84, 83);
     ...
     private static void testBalancedTree4() {
          ...
          List<Integer> ansList = asList(77, 26, 32, 80, 78);
     ...
     private static void testBalancedTree3() {
          ...
          List<Integer> ansList = asList(50, 25, 15, 20, 35, 70, 80, 85, 75);
     ...
     private static void testBalancedTree2() {
          ...
          List<Integer> ansList = asList(15, 6, 4, 5, 7, 23, 71, 50);
     ...
     private static void testBalancedTree1() {
          ...
          List<Integer> ansList = asList(50, 25, 20, 15, 23, 30, 37, 65, 73, 80, 90, 85, 75);
